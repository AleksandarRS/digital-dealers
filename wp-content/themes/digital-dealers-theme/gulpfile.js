let project_name = 'digital-dealers';
...
let config = (function(){
	...
	return {
		...
		/***********************************************************************/
		text_domain: '' || project_name, // Example: 'digitaldealers' #lowercase, separated by underscore or dash ( _ or - )
		packageName: '' || project_name, // Example: 'digitaldealers package' #Capitalized
